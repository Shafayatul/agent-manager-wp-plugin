<?php
ob_start();
function camOrderTrain_ticketListFunction(){
	$cam_display_order_train_ticket_table = new Cam_Order_train_ticket_List_Table();
	$cam_display_order_train_ticket_table->prepare_items();
	?>
		<div class="wrap">
			...
			<?php $cam_display_order_train_ticket_table->display(); ?>
		</div>
	<?php
}
...
class Cam_Order_train_ticket_List_Table extends WP_List_Table {
	...
	private function table_data() {
		...
		$orders          = $wpdb->get_results( "SELECT * FROM ".$table_name." WHERE order_type='train_ticket'", OBJECT );
